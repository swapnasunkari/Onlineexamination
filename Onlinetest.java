...
{  
    ...
    {  
        ...
        if(current==2)  
        {  
            l.setText("Que3: Which package contains Random class?");  
            jb[0].setText("java.lang.package");jb[1].setText("java.util.package ");jb[2].setText("java.lo.package");jb[3].setText("None");  
        }  
        if(current==3)  
        {  
            l.setText("Que4: Which one of these cannot be used for a variable name in java?");  
            jb[0].setText("identifier and keyword");jb[1].setText("identifier");jb[2].setText("keyword");jb[3].setText("none");  
        }  
        if(current==4)  
        {  
        ...
        if(current==9)  
        {  
            l.setText("Que10: Which component is used to complie, debug and execute the java program?");  
